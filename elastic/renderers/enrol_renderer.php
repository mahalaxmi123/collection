...
class theme_elastic_core_enrol_renderer extends core_enrol_renderer {
    ...
    public function render_course_enrolment_users_table(course_enrolment_users_table $table,
        ...
        // Added for the Elastic theme. Make this table responsive.
        ...
        if ($table->has_bulk_user_enrolment_operations()) {
            ...
            // Added for the Elastic theme, a no-overflow wrapper.
