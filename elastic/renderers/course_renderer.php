<?php
// This file is part of The elastic 3 Moodle theme
//
...
class theme_elastic_core_course_renderer extends core_course_renderer {
    ...
    protected function coursecat_coursebox(coursecat_helper $chelper, $course, $additionalclasses = '') {
		...
		$content .= html_writer::start_tag('div', array('class' => 'coursebox clearfix'));
