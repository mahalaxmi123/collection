        ...
        <div class="search-course-wrapper">
            ...
            <div class="col-sm-8 col-sm-offset-2">
                <div class="search-course-inner">
                    <h2>What course you want to learn?</h2>
                    <p>Improve you skills by learnign courses online</p>
                    <form id="coursesearch" action="<?php echo $CFG->wwwroot;?>/course/search.php" method="get" role="form">
                        <div class="input-group">
                            <label for="coursesearchbox" class="sr-only">Search courses</label>
                            <input type="text" id="coursesearchbox" size="30" name="search" class="form-control" value="" placeholder="Search courses">
