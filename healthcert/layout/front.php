...
<?php if (!isloggedin()): ?>
<div class="hidden-xs login-wrapper">
        <div class="container">
        <div class="login-panel">                    	
            <h2 class="hidden-sm">Sign in</h2>                        
            <form action="<?php echo $CFG->httpswwwroot; ?>/login/index.php" method="post" id="login" <?php //echo $autocomplete; ?> >
                <div class="form-group">
                <label class="visible-lg">Username</label>
                <input class="form-control" type="text" name="username" placeholder="<?php echo get_string('username'); ?>" autocomplete="off"/>
                </div>
                <div class="form-group">
                <label class="visible-lg">Password</label>
                ...
                <div class="forgot-password"><strong><a href="<?php $CFG->wwwroot;?>login/forgot_password.php" id="forgotten"><?php echo get_string('passwordforgotten'); ?></a></strong></div>
            </form>
        </div>
	</div>
</div>
...
<div class="main-slideshow">
	 <?php
        $toggleslideshow = theme_healthcert_get_setting('toggleslideshow');
