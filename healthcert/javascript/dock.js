 ...
 *   - Handle the opening/closing of the Healthcert collapsible navbar on small screens.
 */
function customise_dock_for_theme(dock) {
    ...
    // Handle the opening/closing of the healthcert collapsible navbar on small screens.
    // This is a complex little bit of JS because we need to simulate Healthcert actions in order to measure height changes
    ...
    dock.on('dock:initialised', function() {
        ...
        if (navbar && navbarbtn && container) {
            ...
            navbarbtn.ancestor().on('click', function() {
                // We need to fake the collapsible region being active, this JS *ALWAYS* executes before the healthcert JS.
