...
class theme_healthcert_core_course_management_renderer extends core_course_management_renderer {
    ...
    public function grid_column_start($size, $id = null, $class = null) {
        ...
        // Calculate Healthcert grid sizing.
        $healthcertclass = 'col-md-'.$size;

        if (is_null($class)) {
            $class = $healthcertclass;
        } else {
            $class .= ' ' . $healthcertclass;
        }
        $attributes = array();
