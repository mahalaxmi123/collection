...
/**
 * Renderers to align Moodle's HTML with that expected by Healthcert
 *
 * @package    theme_healthcert
 * @copyright  2012
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */

class theme_healthcert_core_renderer extends core_renderer {
    ...
    protected function render_user_menu(custom_menu $menu) {
        ...
        $content = '<ul class="nav navbar-nav pull-right user-menu">';
        foreach ($menu->get_children() as $item) {
            $content .= $this->render_custom_menu_item($item, 1);
        }
    ...
    public function content_zoom() {
        $zoomin = html_writer::span(get_string('fullscreen', 'theme_healthcert'), 'zoomin');
        $zoomout = html_writer::span(get_string('closefullscreen', 'theme_healthcert'), 'zoomout');
