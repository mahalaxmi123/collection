...
class theme_healthcert_core_enrol_renderer extends core_enrol_renderer {
    ...
    public function render_course_enrolment_users_table(course_enrolment_users_table $table,
        ...
        // Added for the Healthcert theme. Make this table responsive.
        ...
        if ($table->has_bulk_user_enrolment_operations()) {
            ...
            // Added for the Healthcert theme, a no-overflow wrapper.
